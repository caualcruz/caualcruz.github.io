function header(){
    headerElement.innerHTML = `  <header class="card, header1">
    <strong class="buton to-left padding-large">
        CLCC
    </strong>
    <nav class="nav-itens">
        <a class="buton to-right padding-large" href="/index.html#contato1">CONTATO</a>
