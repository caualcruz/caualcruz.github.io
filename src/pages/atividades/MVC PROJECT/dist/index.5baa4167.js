...
var _controllerJs = require("./src/controller.js");
(0, _controllerJs.controller).iniciar();

},{"./src/controller.js":"gCE4p"}],"gCE4p":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "controller", ()=>controller);
var _viewControllerJs = require("./view/viewController.js");
var _usuarioModelJs = require("./model/usuario.model.js");
let data = [];
const submitType = {
    NEW: 0,
    UPDATE: 1
...
const handleSubmit = (event)=>{
    ...
    const user = new (0, _usuarioModelJs.Usuario)(nome.value, idade.value, login.value, senha.value);
    if (submitState == submitType.NEW) addUser(user);
    else if (submitState == submitType.UPDATE) {
        updateUser(currentId, user);
        submitState = submitType.NEW;
        btnSub.innerText = "Salvar";
    }
    (0, _viewControllerJs.viewController).update(data, new (0, _usuarioModelJs.Usuario)("", null, "", ""));
};
...
const clickEsquerdo = (event)=>{
    ...
    const confirmAt = window.confirm(`Clicou com o bot\xe3o esquerdo, e o ${data[currentId].getNome().toUpperCase()} ser\xe1 carregado para edi\xe7\xe3o 

    Voc\xea realmente deseja atualizar os dados desse usu\xe1rio?`);
    if (confirmAt) {
        (0, _viewControllerJs.viewController).updateForm(data[currentId]);
...
const clickDireito = (event)=>{
    ...
    if (event.button == 2) {
        currentId = event.target.closest("tr").id.split("")[4];
        const confirmDelet = window.confirm(`Clicou com o bot\xe3o direito, e o ${data[currentId].getNome().toUpperCase()} ser\xe1 deletado 

      Voc\xea realmente deseja deletar esse usu\xe1rio?`);
        if (confirmDelet) deletUser(currentId);
        (0, _viewControllerJs.viewController).update(data, new (0, _usuarioModelJs.Usuario)("", null, "", ""));
    }
};
const controller = {
    iniciar: ()=>{
        (0, _viewControllerJs.viewController).build();
...
},{"./view/viewController.js":"kwPhY","./model/usuario.model.js":"jiRrF","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kwPhY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "viewController", ()=>viewController);
var _formNewUserJs = require("./form-new-user.js");
var _resultViewJs = require("./result-view.js");
const viewController = {
    build: ()=>{
        (0, _formNewUserJs.formNewUser).build();
        (0, _resultViewJs.resultView).build();
    },
    update: (userArray, userToUpdate)=>{
        (0, _resultViewJs.resultView).update(userArray);
        (0, _formNewUserJs.formNewUser).update(userToUpdate);
    },
...
const formNewUser = {
    build: ()=>{
        ...
        <h3 class="mt-2 mb-4"> Cadastro de novo usu\xe1rio </h3>
...
},{}],"3hFNO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
