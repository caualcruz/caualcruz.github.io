      ...
      materias.push({
        ...
        info: `<hr>
                    ...
                    <th>RESULTADO DE: <b>${select.value.toLocaleUpperCase()}</b></th> <br>
                        ...
                        <td><b>1º Bimestre:</b>${inputNotas[0]}</td><br>
                        <td><b>2º Bimestre:</b>${inputNotas[1]}</td><br>
                        <td><b>3º Bimestre:</b>${inputNotas[2]}</td><br>
                        <td><b>4º Bimestre:</b>${inputNotas[3]}</td><br>
                    </tr> 
                        <td>TOTAL FINAL: <b>${totalNotas}</b></td>
                        <td><br>
                          STATUS: <b>${isAprovadoOuReprovado(totalNotas)}</b>
                        </td>
                    `,
      });
    }
    ...
    function validNotas() {
      ...
      for (let i = 0; i < inputNotas.length; i++) {
        if ((i == 0 && inputNotas[0] > 20) || inputNotas[0] < 0) {
          alert(
            "O valor máximo do primeiro bimestre é de 20 pontos e o mínimo 0"
          );
          return true;
        } else if ((i == 0 && inputNotas[1] > 25) || inputNotas[1] < 0) {
          alert(
            "O valor máximo do segundo bimestre é de 25 pontos e o mínimo 0"
          );
          return true;
        } else if ((i == 0 && inputNotas[2] > 25) || inputNotas[2] < 0) {
          alert(
            "O valor máximo do terceiro bimestre é de 25 pontos e o mínimo 0"
          );
          return true;
        } else if ((i == 0 && inputNotas[3] > 30) || inputNotas[3] < 0) {
          alert(
            "O valor máximo do quarto bimestre é de 30 pontos e o mínimo 0"
          );
          return true;
        }
        return false;
